...
# for predicting Covid-19 confirmed cases
# Mahmoud Tahmasebi
...
values_train_val = values[0:270, 1].reshape(-1, 1)
...
confirmed_cases_normalized = scaler.transform(values_train_val)



# define input sequence
raw_seq = list(confirmed_cases_normalized)
...
confirmed_cases_inversed = scaler.inverse_transform(yhat)

np.save("yhat.npy", confirmed_cases_inversed)
print("prediction", confirmed_cases_inversed)
